...
var fixWidth=function(percent){
	...
	var columns_v = [ [ {
		...
		formatter : function(value, row, index) {
			return "<a href=javascript:editdxt('"+row.uuid+"')>查看</a>";
		}
	},{
		...
		width : fixWidth(0.03),
		formatter : function(value, row, index) {
			return "<a href=javascript:deletedxt('"+row.uuid+"')>删除</a>";
		}
	} ] ];
	...
	var toolbar_v = [ {//工具栏
		...
		handler : function() {
			...
			createmodalwindow("添加题目信息", width*0.6, height*0.7, '${baseurl}dxtInput.action');
		}
	} ];
...
/* 	    	onLoadSuccess:function(){
	...
	function editdxt(id){
		...
		//打开修改窗口
		createmodalwindow("题目详细信息", width*0.6, height*0.8, '${baseurl}dxtEdit.action?uuid='+id);
	}
	//删除用户方法
	function deletedxt(id){
	...
	<TABLE class="table_search" align=center>
		<TBODY>
			...
			<TR>
				...
				<td ><INPUT class="easyui-textbox" type="text" name="dxtCustom.teachername"/></TD>
...
<form id="dxtdeleteform" action="${baseurl}dxt/delete.action" method="post">
