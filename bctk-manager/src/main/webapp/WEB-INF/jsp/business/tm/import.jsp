...
//文件导入提交
  function tmimport(){
	  ...
	  jquerySubByFId('itemimportForm',dxtsave_callback,null,"json");
...
<form id="itemimportForm" name="itemimportForm" action="${baseurl}tm/import.action" method="post" enctype="multipart/form-data">
					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							...
							<TR>
								...
								<br>2、点击 <a class="blue" href="${baseurl}template/ypxx_template.xls"><u>题目信息模板</u></a> 下载，并按照说明录入题目信息。
							...
							<TR>
								...
								<input class="easyui-filebox" data-options="buttonText:'选择'" name="tmImportFile" />					
								</TD>
							</TR>
							<TR>
								
								<TD colspan=2  align=center style="background:#fff;">
									<a id="submitbtn"  class="easyui-linkbutton"   iconCls="icon-ok" href="#" onclick="tmimport()">提交</a>
								</TD>
							</TR>
						</TBODY>
					</TABLE>
