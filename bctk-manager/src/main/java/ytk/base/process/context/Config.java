package ytk.base.process.context;
...
public class Config {
	 ...
	 * 公共权限，需要给用户分配权限即可使用
	 */
	public static final String COMMON_ACTIONS = "resources.commonActions";
	
	/**
	 * 公开权限，用户无需登录即可使用
	 */
	public static final String ANONYMOUS_ACTIONS = "resources.anonymousActions";
